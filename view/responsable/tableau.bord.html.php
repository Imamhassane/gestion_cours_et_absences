                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 ">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body pb-5">
                                    <div class="chart-pie pt-2 pb-5"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas id="myPieChart" width="595" height="245" style="display: block; width: 595px; height: 245px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas id="" width="735" height="320" style="display: block; width: 735px; height: 320px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div> -->
