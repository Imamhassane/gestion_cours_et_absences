...
<div class="area"></div><nav class="main-menu">
                ...
                <div class="case-container">
                        ...
                        <div class="case-content">
                            <div class="case-content-item ml-5">
                                <li class="">
                                    <a href="<?= WEB_ROUTE . '?controllers=responsable&view=creer.professeur' ?>">
                            ...
                            <div class="case-content-item ml-5 ">
                                <li class="m">
                                    <a href="<?= WEB_ROUTE . '?controllers=responsable&view=creer.classe' ?>">
            ...
            <?php if (!est_responsable()): ?>
                ...
                <li class="mt-3">
                   <a href="<?= WEB_ROUTE . '?controllers=responsable&view=liste.etudiant' ?>">
                   <i class="fa fa-list fa-2x"></i>
                        <span class="nav-text">
                            Liste des etudiants
                        </span>
                   ...
                   <a href="#">
                       <i class="fa fa-plus fa-2x"></i>
                        ...
                        <div class="dropdown-content">
                            <a href="<?= WEB_ROUTE . '?controllers=responsable&view=creer.professeur' ?>">Un professeur</a>
