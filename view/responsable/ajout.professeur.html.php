    ...
    ?>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <?php else:?>
                    <div class="text-center mb-3"><h2 >Modifier le profil</h2></div>
                <?php endif?>
                        ...
                        <div class="form-inline">
                            ...
                            <?php endif ?>
                                <div class=" mb-2 col-md-6">
                                    ...
                                    <input type="text" name="login" placeholder="" value="<?=$users[0]['login']?>">
                                    <small class = "ml-5 text-left form-text text-danger ">
                                ...
                                <?php if($_GET['view']=='inscrire.etudiant' || $_GET['view']=='reinscrire'  ):?>
                                    ...
                                    <div class=" col-md-6 mb-4 mt-2">
                                        ...
                                        <option value="<?=$users[0]['id_classe']?>"><?=$users[0]['nom_classe']?></option>
                                ...
                                <?php endif ?>
                                    ...
                                    <?php if( (est_responsable() && $_GET['view']=='ajout.professeur') ||  est_attache() && $_GET['view']=='inscrire.etudiant' || $_GET['view']=='modifprofil' ) :?>
                                        <div class=" mb-2 col-md-4 ml-">
                                        <label for="" class = "ml-5 mb-1">avatar</label>
                                            <input type="file" name="avatar" class="ml-5"   placeholder="" value="">
                                            <small class = "ml-5 text-left form-text text-danger ">
